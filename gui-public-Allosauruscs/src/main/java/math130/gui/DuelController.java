...
/**
 * The class for controlling pretty much all of the functions and actions of the duel.
 * @author Allosauruscs
 */
public class DuelController {
    ...
    @FXML
    private ImageView opponentDeckVisualPile;
...
// Assuming: Row 1 = Opponent Monsters, Row 2 = Player Monsters
    ...
    /**
     * Creates each card and makes each one unique to prevent errors like with battling
     * @param cardData
     * @return
     */
    ...
    @FXML
    private Label opponentDeckSizeLabel;
    ...
    @FXML
    private ScrollPane opponentHandScrollPane;
...
private ImageView selectedCardView = null;
    ...
    private void activateSpellEffect(SpellCard spell, ImageView spellCardView) {
        ...
        // --- 3. DARK HOLE EFFECT (Changed to Ding Ding Ding) ---
        if (spell.getName().equalsIgnoreCase("Ding Ding Ding")) {
            System.out.println("--- Ding Ding Ding ACTIVATED: WIPING THE ENTIRE FIELD ---");
            int destroyedCount = 0;
            ...
            summonText.setText("Hector activated! " + destroyedCount + " monsters on the field were destroyed.");
            yourHand.getChildren().remove(spellCardView);
            selectedCardView = null;
        }
    }
    ...
    /**
     * This method simply updates life point values for events like battling.
     */
    ...
    /**
     * When it is the battle phase, allows the player to click a monster card and click an opposing monster to attack it
     * @param clickedZoneImageView to know what card the player clicked
     */
    ...
    /**
     * method for starting opponent turn, starting with draw phase here
     */
    ...
    /**
     * main phase for opponent method
     * @param currentActionCount
     * @param maxActionsAllowed
     */
    ...
    /**
     * method for opponent to summon monsters and activate spells.
     * @return
     */
    ...
    /**
     * method after ending main and going to battle, waits 1.5 seconds before battling.
     */
    ...
    /**
     * for activating spell cards and having their effects go through.
     * @param spell
     */
    ...
    /**
     * for the opponent to attack with their monsters.
     */
    ...
    /**
     * method so opponent attacks depending on if they have monsters to do so.
     * @param attackersList
     * @param currentIndex
     */
    ...
    /**
     * Method for moving through the phases
     * @param event
     */
    @FXML
    ...
    /**
     * automatically draw a card at start of draw phase
     */
    ...
    /**
     * for summoning monsters and battling monsters
     * @param event
     */
    @FXML
...
// If Scene Builder defaults the first row/col to null, map them correctly to 0
    ...
    /**
     * for calculating life points when attacked directly, or doing the math depending on the atk of the monster cards.
     * @param attackerSlot
     * @param attacker
     * @param targetSlot
     * @param target
    ...
    /**
     * checking if opponent has monsters or not so that you can attack directly
     * @return
     */
    ...
    /**
     * for making monsters be able to attack in following turns
